...
public final class FragmentTeamBinding implements ViewBinding {
  ...
  private FragmentTeamBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerTeam) {
  ...
  public static FragmentTeamBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTeamBinding((LinearLayout) rootView, recyclerTeam);
    }
